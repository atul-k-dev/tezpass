...
export default function Header() {
  ...
  return (
    <header className="fixed top-3 left-0 w-full z-50 px-4 md:px-10">
      ...
      <div className="grid grid-cols-3 gap-1 pointer-events-none">
        ...
        <div className="col-span-2 md:col-span-2 flex items-center gap-5 pointer-events-auto">
          <div className="flex items-center">
            <svg className="logo reveal" width="46" height="46" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect x="52" y="40" width="152" height="28" rx="14" fill="var(--fg)" />
              <path d="M108 68H154L136 112H176L100 216L118 144H92L108 68Z" fill="var(--fg)" />
            </svg>
          </div>
        ...
        <div className="col-span-1 flex justify-end items-center gap-3 pointer-events-auto">
          ...
          <div className="hidden md:flex items-center gap-3">
            <button className="w-12 h-12 bg-primary rounded-full flex items-center justify-center text-primary-fg hover:bg-primary/80 pl-1 transition-colors">
